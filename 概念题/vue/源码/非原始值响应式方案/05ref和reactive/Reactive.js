...
function ref(value) {
  ...
  Object.defineProperty(wrapper, "__ref_wrapper", {
    value: true,
  });
...
function proxyRef(obj) {
  return new Proxy(obj, {
    ...
    set(target, key, newValue, receiver) {
      ...
      if (target[key].__v_ref) {
        res = Reflect.set(target[key], "value", newValue, receiver);
      } else {
        value = Reflect.set(target, key, newValue, receiver);
      }
    },
  });
}
