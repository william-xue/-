...
// 问题
// let obj = ref({ name: "zs", age: 15 });
// let newObj = { ...obj };
// // 这种情况下当我改变newObj.name的时候副作用函数不会执行原因是...obj会把newObj变成{ name: "zs", age: 15 }没有代理了
// effect(() => {
...
// 解决方案 将newObj进行toRef
// 原理
// let obj = reactive({ name: "zs", age: 15 });
// let newObj = proxyRef({ ...toRefs(obj) });
